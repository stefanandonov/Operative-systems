...
import examsSynch.AluminiumHydroxide.Hydrogen;
import examsSynch.AluminiumHydroxide.Oxygen;
...
import synchronization.Switcher;
...
public class AluminiumHydroxideState extends AbstractState {
	...
	public void bondOH() {
		...
		} else if (getThread() instanceof examsSynch.AluminiumHydroxide.Hydrogen) {
