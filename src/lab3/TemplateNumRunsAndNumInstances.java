...
public class TemplateNumRunsAndNumInstances {
    ...
    public static Semaphore daSeBude = new Semaphore(0);
    public static Semaphore lock = new Semaphore(1);
    public static boolean spie = true;
    //public static Semaphore vlezi = new Semaphore(0);
    public static Semaphore mozeDaSedne = new Semaphore(0);
    public static Semaphore zafateno = new Semaphore(1);
    public static Semaphore mozeDaPlati = new Semaphore(0);
    public static int klienti = 0;
