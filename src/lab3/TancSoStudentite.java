...
public class TancSoStudentite {
	...
	public static Semaphore maskaSoblekuvalna = new Semaphore(10);
	public static Semaphore zenskaSoblekuvalna = new Semaphore(10);
	public static Semaphore voSoblekuvalna = new Semaphore(0);
	public static Semaphore slobodnaSoblekuvalna = new Semaphore(1);
	public static Semaphore partner = new Semaphore(0);
	public static Semaphore paroviTanc = new Semaphore (3);
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
        	...
        	//slobodnaSoblekuvalna.acquire(1);
        	maskaSoblekuvalna.acquire(1);
        	//voSoblekuvalna.release(1);
        	show.presobleci();
